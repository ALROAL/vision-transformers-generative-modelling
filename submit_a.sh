...
python3 main.py --name ViTVAE_GAN_batch64 --model-type ViTVAE_GAN --batch_size 64 --max-epochs 200 --num-workers 8 >| outputs/ViTVAE_GAN_2_05_batch64.out 2>| error/ViTVAE_GAN_2_05_batch64
.err
