...
python3 main.py --name ViTVAE_GAN_prep_f01_batch512 --model-type ViTVAE_GAN_prepared --batch_size 512 --max-epochs 200 --num-workers 8 >| outputs/ViTVAE_GAN_f01_batch512.out 2>| error/ViTVAE_GAN_f01_batch512.err
