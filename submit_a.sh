...
python3 main.py --name ViTVAE_GAN_batch1 --model-type ViTVAE_GAN --batch_size 1 --max-epochs 100 --num-workers 8 >| outputs/ViTVAE_GAN_batch1.out 2>| error/ViTVAE_GAN_batch1.err
