...
python3 main.py --name ViTVAE_GAN_prepared_3--model-type ViTVAE_GAN_prepared --batch_size 8 --max-epochs 200 --num-workers 8 >| outputs/ViTVAE_GAN_prepared_3.out 2>| error/ViTVAE_GAN_prepared_3.err
