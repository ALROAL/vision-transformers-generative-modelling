...
python3 main.py --name ViTVAE_PatchGAN --model-type ViTVAE_PatchGAN --batch_size 8 --max-epochs 100 --num-workers 8 >| outputs/ViTVAE_PatchGAN3.out 2>| error/ViTVAE_PatchGAN3.err
