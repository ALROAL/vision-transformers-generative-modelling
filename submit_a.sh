...
python3 main.py --name ViTVAE_PatchGAN_batch1_lr --model-type ViTVAE_PatchGAN --batch_size 1 --max-epochs 100 --num-workers 8 >| outputs/ViTVAE_PatchGANGAN_batch1_lr.out 2>| error/ViTVAE_PatchGAN_batch1.err
