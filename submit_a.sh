...
python3 main.py --name ViTVAE_PatchGAN_prepared --model-type ViTVAE_PatchGAN_prepared --batch_size 8 --max-epochs 100 --num-workers 8 >| outputs/ViTVAE_PatchGAN_prepared.out 2>| error/ViTVAE_PatchGAN_prepared.err
