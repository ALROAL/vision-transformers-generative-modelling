...
python3 main.py --name ViTVAE_PatchGAN --model_type ViTVAE_PatchGAN --batch_size 8 --max-epochs 100 --num-workers 8 >| outputs/ViTVAE_PatchGAN.out 2>| error/ViTVAE_PatchGAN.err